    ...
    <div class="main-w3layouts wrapper">
        ...
        <div class="main-agileinfo">
            <div class="agileits-top">
                ...
                <p>Don't have any Account? <a href="admin_registration.php"> Register Now!</a></p>
            </div>
        </div>
        <!-- copyright -->
        <div class="colorlibcopy-agile">
            <p>© 2024 Admin Registration Form. All rights reserved | Design by <a href="./index" target="_blank">SBPGC</a></p>
        </div>
        <!-- //copyright -->
