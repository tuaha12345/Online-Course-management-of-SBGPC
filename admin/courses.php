...
<!-----------1st row (teacher info and course info)--------------------------->
                ...
                <div class="border border-secondary  m-5" style='width:90%'>
                    ...
                    <div class="row my-3">
                        ...
                        <?php
                         ...
                         {
                            echo "<a href='' class='text-info  col-md-1 fs-4 ms-2'>ASN$ASN_no</a>";
                            // $quiz_no+=1;
                            $ASN_no+=1;
                         }
       ...
       <div class="text-center bg-primary m-5 px-5 rounded">
          <?php
           echo "<a href='weeklysection.php?course_code=$course_code&teacher_name=$teacher_name' class='text-decoration-none ' ><p class='text-white fs-4 py-3'>Add New Week</p></a>";  ?>
       </div>
