...
<?php   include('partials/navbar.php'); ?> <!---------- navbar----------->
    ...
    <div class="row " style="background-color: #edf0ed;" >
       ...
       <?php   include('partials/sidebar.php'); ?> <!---sidebar --->
        ...
        <h3 class="text-monospace text-center">Mid Exam Question</h3><br>
            <div class="row rounded shadow" style="background-color: #faeeca;">
                ...
                <div class="col-md-12 m-5 row">
                        ...
                        <div class="col-md-6 my-3">
                           <label for="course_code" class="fw-bold ">Mid Exam:</label><br>
                            <strong class="text-secondary"><?php echo $mid_question ?></strong> 
                        </div>

                        <div class="col-md-12 my-3 text-center">

                           <a href="../admin/uploads/exam_question/<?php echo $row['mid_pdf']; ?>" download class="fw-bold text-danger fs-4">Download Question Here</a><br>
